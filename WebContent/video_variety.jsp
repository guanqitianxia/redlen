...
<div class="header">
  ...
  <div class="header2">视频
    ...
    <a href="OutServlet?id=<%=id0%>"><button>退出</button></a>
...
<div class="search-container">
 ...
 <div class="parent_classify">
   ...
   <a href="video_variety.jsp?id=<%=id0%>&usertype=<%=usertype%>"><button style="background-color:#ccc">综艺</button></a>
   <button>小视频</button>
 </div>
...
<div class="sub_classify">
   ...
   <label><input name="sub_clif" value="asia" type="checkbox" />亚洲</label>
     <br>
   <label><input name="sub_clif" value="sports" type="checkbox" />体育</label>
   <label><input name="sub_clif" value="showbiz" type="checkbox" />娱乐</label>
   <label><input name="sub_clif" value="funny" type="checkbox" />搞笑</label>
   <label><input name="sub_clif" value="humanshow" type="checkbox" />真人秀</label>
   <label><input name="sub_clif" value="emotion" type="checkbox" />情感</label>
   <label><input name="sub_clif" value="fool" type="checkbox" />美食</label>
   <label><input name="sub_clif" value="travel" type="checkbox" />旅游</label>
   <label><input name="sub_clif" value="draft" type="checkbox" />选秀</label>
...
Statement stmt=null;
String sql="select * from videobase where type0='variety'";
int flag=1;
try
{
