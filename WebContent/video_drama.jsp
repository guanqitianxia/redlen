...
<div class="search-container">
 ...
 <div class="parent_classify">
   ...
   <a href="video_drama.jsp?id=<%=id0%>&usertype=<%=usertype%>"><button style="background-color:#ccc">电视剧</button></a>
...
<div class="sub_classify">
   ...
   <label><input name="sub_clif" value="family" type="checkbox" />家庭</label>
   ...
   <label><input name="sub_clif" value="myth" type="checkbox" />神话</label>
   <label><input name="sub_clif" value="immortal" type="checkbox" />仙侠</label>
...
Statement stmt=null;
String sql="select * from videobase where type0='drama'";
int flag=1;
try
{
