...
<div class="search-container">
 ...
 <div class="parent_classify">
   ...
   <a href="video_comic.jsp?id=<%=id0%>&usertype=<%=usertype%>"><button style="background-color:#ccc">动漫</button></a>
...
<div class="sub_classify">
   ...
   <label><input name="sub_clif" value="asia" type="checkbox" />亚洲</label>
     <br>
   <label><input name="sub_clif" value="blood" type="checkbox" />热血</label>
   <label><input name="sub_clif" value="harem" type="checkbox" />后宫</label>
   <label><input name="sub_clif" value="sports" type="checkbox" />电竞</label>
   <label><input name="sub_clif" value="love" type="checkbox" />爱情</label>
   <label><input name="sub_clif" value="school" type="checkbox" />校园</label>
   <label><input name="sub_clif" value="fantasy" type="checkbox" />玄幻</label>
...
Statement stmt=null;
String sql="select * from videobase where type0='comic'";
int flag=1;
try
{
